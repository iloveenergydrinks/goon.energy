  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2 text-sm">
        <span className="px-2 py-1 rounded border border-neutral-300 bg-neutral-50 text-black">
          Seed: <span className="font-mono">{seed}</span>
        </span>
        <button
          className="px-2 py-1 border border-neutral-300 rounded hover:bg-neutral-50 text-black"
          onClick={() => {
            rollSeed();
            generate();
          }}
      ...
      <div>
        <button className="px-3 py-2 border border-neutral-300 rounded hover:bg-neutral-50 text-black" onClick={copy}>
          Copy Permalink
        </button>
      </div>
    </div>
