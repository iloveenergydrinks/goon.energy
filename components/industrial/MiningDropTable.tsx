...
const COMPONENT_DROPS = {
  common: [
    { id: 'flux_dust', name: 'Flux Dust', emoji: '✨', baseRate: 1.0, minRoom: 1, minTier: 2, description: '+5% quality on any craft', use: 'Optional enhancer' },
    { id: 'circuit_fragment', name: 'Circuit Fragment', emoji: '🔌', baseRate: 0.6, minRoom: 1, minTier: 2, description: 'Required for electronic modules', use: 'Crafting component' },
    { id: 'alloy_binder', name: 'Alloy Binder', emoji: '🔗', baseRate: 0.8, minRoom: 1, minTier: 2, description: 'Reduces quality mismatch penalty', use: 'Optional enhancer' },
    { id: 'cooling_gel', name: 'Cooling Gel', emoji: '❄️', baseRate: 0.5, minRoom: 1, minTier: 2, description: 'Required for energy weapons', use: 'Crafting component' },
  ],
  uncommon: [
    { id: 'power_core', name: 'Power Core', emoji: '⚡', baseRate: 0.4, minRoom: 2, minTier: 3, description: 'Required for T2+ weapons and shields', use: 'Required for Tier 2' },
    { id: 'control_matrix', name: 'Control Matrix', emoji: '🎛️', baseRate: 0.3, minRoom: 2, minTier: 3, description: 'Required for targeting systems', use: 'Required for Tier 2' },
    { id: 'structural_lattice', name: 'Structural Lattice', emoji: '🏗️', baseRate: 0.5, minRoom: 1, minTier: 3, description: 'Required for armor and hull mods', use: 'Required for Tier 2' },
    { id: 'neural_processor', name: 'Neural Processor', emoji: '🧠', baseRate: 0.2, minRoom: 3, minTier: 3, description: 'Required for AI modules', use: 'Required for Tier 2' },
  ],
  rare: [
    { id: 'quantum_processor', name: 'Quantum Processor', emoji: '💎', baseRate: 0.1, minRoom: 3, minTier: 4, description: 'Required for T3+ advanced weapons', use: 'Required for Tier 3' },
    { id: 'zero_point_capacitor', name: 'Zero-Point Capacitor', emoji: '🔮', baseRate: 0.05, minRoom: 4, minTier: 4, description: 'Required for elite shields', use: 'Required for Tier 3' },
    { id: 'graviton_mesh', name: 'Graviton Mesh', emoji: '🌀', baseRate: 0.08, minRoom: 3, minTier: 4, description: 'Required for propulsion systems', use: 'Required for Tier 3' },
    { id: 'plasma_injector', name: 'Plasma Injector', emoji: '💉', baseRate: 0.15, minRoom: 3, minTier: 4, description: 'Damage amplifier component', use: 'Required for Tier 3' },
  ],
  legendary: [
    { id: 'singularity_core', name: 'Singularity Core', emoji: '🌟', baseRate: 0.01, minRoom: 5, minTier: 5, description: 'Required for doomsday weapons', use: 'Required for Tier 5' },
    { id: 'chrono_fragment', name: 'Chrono Fragment', emoji: '⏳', baseRate: 0.005, minRoom: 1, minTier: 2, description: '🎰 LOTTERY ITEM - Can drop anywhere!', use: 'Ultra rare component' },
    { id: 'void_crystal', name: 'Void Crystal', emoji: '🔷', baseRate: 0.02, minRoom: 4, minTier: 5, description: 'Interdimensional technology', use: 'Required for Tier 5' },
    { id: 'dark_energy_cell', name: 'Dark Energy Cell', emoji: '⚫', baseRate: 0.008, minRoom: 5, minTier: 5, description: 'Infinite power source', use: 'Required for Tier 5' },
  ]
};
